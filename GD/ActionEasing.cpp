...
#define EASE_TEMPLATE_IMPL(CLASSNAME, TWEEN_FUNC)   \
    ...
    void CLASSNAME::update(float time) { innerAction->update(TWEEN_FUNC(time)); }
...
#define EASERATE_TEMPLATE_IMPL(CLASSNAME, TWEEN_FUNC)   \
    ...
    void CLASSNAME::update(float time) { innerAction->update(TWEEN_FUNC(time, rate)); }
...
#define EASEELASTIC_TEMPLATE_IMPL(CLASSNAME, TWEEN_FUNC)   \
    ...
    void CLASSNAME::update(float time) { innerAction->update(TWEEN_FUNC(time, period)); }
