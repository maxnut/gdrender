...
std::shared_ptr<RenderTexture> RenderTexture::create(glm::vec2 resolution)
{
...
bool RenderTexture::init(glm::vec2 resolution)
{
...
void RenderTexture::resize(glm::vec2 resolution)
{
